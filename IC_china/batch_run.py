...
class getIC_INFO:
    ...
    def Shareholder_investment_info(self):
        ...
        #得到总页数
        try:
            ye = driver.find_element_by_xpath('//*[@id="shareholderInfo_info"]').text
        ...
        for h in range(int(ye_num)):
            ...
            driver.find_element_by_xpath('//*[@id="shareholderInfo_next"]/a').click()
            time.sleep(10)
        # print jitichuzhi
